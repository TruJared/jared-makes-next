        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <h2 className="h6">
              ...
              efficiency, and building the future.
            </h2>
            <div className="mt-6 space-y-7 text-base leading-relaxed">
              <p>
                ...
                then, I've focused more on front-end development leveraging my
              ...
              <p>
                ...
                NextJS, Astro, Svelte, Tailwind CSS, Sanity, Big Commerce and
